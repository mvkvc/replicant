defmodule PlatformWeb.StatsLive do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col space-y-4">
      ...
      <p>Last updated: <%= NaiveDateTime.to_string(@last_updated) %></p>
      <div class="flex flex-col space-y-4">
  ...
  def mount(_params, _session, socket) do
    Process.send_after(self(), :update_plots, @update_interval)

    {:ok, update_plots(socket)}
  end

  @impl true
  def handle_info(:update_plots, socket) do
    {:noreply, update_plots(socket)}
  end

  defp update_plots(socket) do
