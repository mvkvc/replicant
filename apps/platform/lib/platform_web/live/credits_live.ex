defmodule PlatformWeb.CreditsLive do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col space-y-2">
      ...
      <p>Required credits to participate: <%= min_balance() %></p>
      ...
      <% else %>
        <p class="mb-2 text-center">Showing last <%= @transactions_limit %> transactions</p>
          ...
          <tbody>
            <%= for transaction <- @transactions do %>
              <tr>
                ...
                <td class={
                  "bg-opacity-40 border px-4 py-2"
                  # Couldn't find one that looks good to me
